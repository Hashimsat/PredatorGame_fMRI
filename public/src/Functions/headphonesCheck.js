...
export default class HeadphonesCheck {
    ...
    constructor(settings = {}) {
        this._settings = {
            callback: undefined,
            volumeSound: 'assets/stimuli_HugginsPitch/HugginsPitch_calibration.flac',
            ...
            checkType: 'huggins',
            checkVolume: 1,
            checkExample: 'assets/stimuli_HugginsPitch/HugginsPitch_example_2.flac',
            checkSounds: [
                {answer: 1, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set1_1.flac'},
                {answer: 2, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set1_2.flac'},
                {answer: 3, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set1_3.flac'},
                {answer: 1, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set2_1.flac'},
                {answer: 2, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set2_2.flac'},
                {answer: 3, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set2_3.flac'},
                {answer: 1, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set3_1.flac'},
                {answer: 2, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set3_2.flac'},
                {answer: 3, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set3_3.flac'},
                {answer: 1, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set4_1.flac'},
                {answer: 2, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set4_2.flac'},
                {answer: 3, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set4_3.flac'},
                {answer: 1, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set5_1.flac'},
                {answer: 2, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set5_2.flac'},
                {answer: 3, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set5_3.flac'},
                {answer: 1, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set6_1.flac'},
                {answer: 2, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set6_2.flac'},
                {answer: 3, file: 'assets/stimuli_HugginsPitch/HugginsPitch_set6_3.flac'},
            ],
            trialCount: 3,
            passMark: 2,
            maxAttempts: 2,
        ...
        this.htmlElements = {
            huggins: {
                instruction: '<p class="notice">Now we will perfrom a sound check.</p>' +
            ...
            reattempt: '<p class="notice">Unfortunately, you did not pass the sound check.</p>' +
     ...
     */
    checkHeadphones(scene, callback, checkVolume = true, repeat) {
    ...
    _instruction(scene) {
        ...
        const promise = this._createDialog({content: html, title: 'Sound check', yes: 'I am ready to begin', back: 'Back'});
        ...
        promise.then(
            () => {
                this._performCheck(scene);
            },
            () => {
                void this.checkHeadphones(scene,undefined, this._checkVolume, true);
            },
        );
    }
    ...
    _offerReattempt(scene) {
        ...
        this._createDialog({content: html, title: 'Sound check failed', yes: 'Try again', color: '#FFA500'})
            .then(() => {
                this._instruction(scene);
            });
    }
    ...
    _performCheck(scene) {
        ...
        const promise = this._createDialog({content: html, title: 'Sound check', yes: 'Continue'});
        $('button:contains("Continue")')
            .button('option', 'disabled', true)
            .css('visibility', 'hidden');
        this._trialHandler(this._settings.trialCount);
        scene.cache.game.data.HeadPhonePassThreshold.push(this._settings.passMark)
        promise.then(() => {
            if (this.isHeadphones) {

                scene.cache.game.data.HeadPhoneCheckPassFail.push('Pass')
                scene.cache.game.data.HeadPhoneCheckScore.push(this.currentCorrect)
                window.alert('Sound Check Passed')
                ...
                if (this.attemptCount < this._settings.maxAttempts) {
                    scene.cache.game.data.HeadPhoneCheckPassFail.push('Fail - Offering Reattempt')
                    scene.cache.game.data.HeadPhoneCheckScore.push(this.currentCorrect)
                    this._offerReattempt(scene);
                } else {
                    scene.cache.game.data.HeadPhoneCheckPassFail.push('Fail - Game ends')
                    scene.cache.game.data.HeadPhoneCheckScore.push(this.currentCorrect)
                    window.alert("Sound Check Failed. Unfortunately you can't continue the experiment.")
                    scene.scene.start('failedsoundcheck-end')
    ...
    _trialHandler(remaining, current = 0) {
        ...
        if (remaining <= 0) {
            ...
            this.currentCorrect = this._currentRecord.numberCorrect
        ...
        $('#headphones-dialog').dialog('option', 'title', 'Sound check (' + current + ' of ' + this._settings.trialCount + ')');
        ...
        return new Promise((resolve, reject) => {
            function resizeToFit() {
                dialog
                    ...
                    .dialog('option', 'position', {my: 'center', at: 'center', of: window, collision: 'none'});

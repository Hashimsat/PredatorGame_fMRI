...
export default class VideoTraining extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.video('training_vid','assets/TrainingVid.mp4')
    ...
    create() {
        ...
        this.Video = this.add.video(sc_widt,sc_high,'training_vid')
    ...
    update() {
        ...
        if (!this.Video.isPlaying()) {
            this.scene.start('AfterVideoInstruct', {playerImageKey: this.playerImage})

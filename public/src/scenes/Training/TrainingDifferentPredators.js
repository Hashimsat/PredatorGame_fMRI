...
export default class TrainingDifferentPredators extends Phaser.Scene {
    ...
    Predator_PredefinedTypes = [3,2,1,2,1,3,2,1,2,2]
    ...
    sceneName = 'TrainingDifferentPreds'
    ...
    create() {
       ...
       // console.log('TRAINING DIFFERENT PREDATORS STARTED')
        ...
        // RotatePredatorToPlayer(this,this.theta,this.predator,this.Player)

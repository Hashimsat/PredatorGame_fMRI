...
export default class AfterVideoInstruction extends Phaser.Scene {
    ...
    constructor() {
        super('AfterVideoInstruct')
    }

    preload() {

        this.load.image('Slide12','assets/Resize12.png')
    ...
    create() {
        ...
        var Instruct1 = this.add.image(sc_widt,sc_high,'Slide12')
